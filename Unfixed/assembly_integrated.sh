...
echo "Running cloudSPAdes + Ariadne for the ${1} ${2} dataset with a search distance of ${3}..."
...
python ${IHDIR}/scripts/ariadne_support.py complete_reads ${READIR}.R1.fastq ${OUTDIR}/${3}.R1.fastq ${OUTDIR}/${3}_full.R1.fastq
python ${IHDIR}/scripts/ariadne_support.py complete_reads ${READIR}.R2.fastq ${OUTDIR}/${3}.R2.fastq ${OUTDIR}/${3}_full.R2.fastq
